...
import ru.kpfu.consumer.util.DbWork
import ru.kpfu.consumer.util.showError
import ru.kpfu.consumer.util.showInfo
...
class AbstractEntityTabController<T>: CrudController {
    ...
    fun onForceUpdateAction() = repository.forceUpdate()
